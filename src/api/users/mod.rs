use actix_web::{web, web::resource, web::get, web::post, web::patch, web::delete, Scope};
mod service_create;
mod service_delete;
...
pub fn service() -> Scope {
    web::scope("/api/users")
        ...
        .service(resource("/id/{user_id}/delete").route(delete().to(service_delete::delete))) // DELETE users
}